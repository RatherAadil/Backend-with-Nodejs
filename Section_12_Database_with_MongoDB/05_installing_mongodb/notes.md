## MongoDB Server Summary
    ...
    -> On installation, MongoDB defaults to a virtual test database, which isn’t created on
        disk until data is stored.
...
## Clients to Connect to MongoDB Server
    ...
    -> MongoDB VS Code Extension:
        ...
        Often provides more detailed views and features than Compass (like document preview,
        schema, and queries within the editor).
