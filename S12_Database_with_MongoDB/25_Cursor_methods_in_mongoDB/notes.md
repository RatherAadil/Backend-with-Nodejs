...
**MongoDB cursor** is an **iterator object that points to query results and fetches documents lazily (batch-by-batch) instead of loading all data into memory at once**.
